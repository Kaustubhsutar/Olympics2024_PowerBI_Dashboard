...
# Update this path to your Kaggle configuration directory
os.environ['KAGGLE_CONFIG_DIR'] = 'C:/Users/Asus/.kaggle'

# Specify the dataset identifier
dataset = 'piterfm/paris-2024-olympic-summer-games'

# Set the download path
# Change this to your preferred download directory
